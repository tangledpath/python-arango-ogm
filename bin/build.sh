...
poetry run pdoc python_arango_ogm/* -o ./docs --logo https://github.com/tangledpath/python-arango-ogm/blob/master/pao.png --favicon https://github.com/tangledpath/python-arango-ogm/blob/master/pao_sm.png
poetry build
